...
from utils.benchmark import benchmark_memory

def main():
    parser = argparse.ArgumentParser(description="Benchmark VRAM usage for Transformer vs Hybrid Gated DeltaNet-2")
